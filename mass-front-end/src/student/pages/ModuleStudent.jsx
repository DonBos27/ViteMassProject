  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col w-full mr-4 mb-4 mt-4 h-full">
        <NavbarStudent Icon={HomeIcon} title={"Modules"} handleProfile={handleProfile} />
        <div className='mt-4 rounded-lg'>
          <h3 className="m-4 text-5xl text-black font-bold">Welcome to MASS John Muninga!</h3>
        </div>
        <Card className='w-full mt-4'>
          <div className='p-8'>
          <Typography variant="h3" color="black">Modules</Typography>
        ...
        <div className="w-full ml-4 mt-4">
          <div>
            <Typography variant="h3" color="black">Announcements</Typography>
          </div>
          <div>
          {
            data.map((item) => (
